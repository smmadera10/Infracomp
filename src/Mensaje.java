...
public class Mensaje {
	 ...
	 */
	public Mensaje(int id, Cliente remitente)
	{
		this.id = id;
	 ...
	 */
	public Mensaje(int id, Cliente remitente, String mensaje)
	{
		this.id = id;
		this.remitente = remitente;
	 ...
	 */
	private void enviarRespuestaARemitente()
	{
		remitente.recibirRespuestaMensaje();
	}
